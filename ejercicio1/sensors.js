class Sensor {
    static permitidos = ["temperature", "humidity", "pressure"];
    constructor(id, name, type, value, unit, updated_at) {
        this.id = id;
        this.name = name;
        if (Sensor.permitidos.includes(type)){
            this.type = type;
        } else {
            console.log("Valor de 'type' no permitido: solo puede ser alguno de los valores 'temperature', 'humidity', 'presure' ")
        }
        //this.type = type;
        this.value = value;
        this.unit = unit;
